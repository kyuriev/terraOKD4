...
resource "libvirt_domain" "okd4-services" {
  ...
  graphics {
    ...
    autoport    = true
      ...
      command = <<EOF
        sleep 120; ANSIBLE_ROLES_PATH=/home/kor/.ansible/roles/ ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i ../../provisioning/inventory ../../provisioning/okd4-services/main.yml
       EOF
   }
}
